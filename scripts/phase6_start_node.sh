...
export OBSERVABILITY_ENABLED=true OBSERVABILITY_HOST=127.0.0.1 METRICS_ENABLED=true TRACING_ENABLED=true OTEL_EXPORTER_OTLP_ENDPOINT=http://127.0.0.1:4318 OTEL_SERVICE_NAME=distsys-node OTEL_TRACE_SAMPLE_RATIO=0.10 OTEL_EXPORT_TIMEOUT_SECONDS=2.0
export RUN_CHAOS_TESTS=1 PHASE6_PEER_PROXY_MAP='node-0=127.0.0.1:19100,node-1=127.0.0.1:19101,node-2=127.0.0.1:19102'
